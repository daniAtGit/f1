            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('editions.index')" :active="request()->routeIs('editions.*')" wire:navigate>
                                <i class="fa fa-calendar"></i> Editions
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('drivers.index')" :active="request()->routeIs('drivers.*')" wire:navigate>
                                <i class="fa fa-gamepad"></i> Drivers
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('teams.index')" :active="request()->routeIs('teams.*')" wire:navigate>
                            ...
                            <x-dropdown-link :href="route('countries.index')" :active="request()->routeIs('countries.*')" wire:navigate>
